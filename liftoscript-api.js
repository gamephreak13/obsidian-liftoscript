...
var freeExercises_default = [
  {
    ...
    instructions: [
      ...
      "At the top of the contraction your torso should be perpendicular to the ground. Reverse the motion, going only \xBE of the way down.",
  ...
  },
  {
    ...
    instructions: [
      ...
      "Position the elbow against your side with the elbow bent at 90\xB0 and the arm pointing towards the pulley. This will be your starting position.",
...
function normalizeFreeExercise(record) {
  ...
  return {
    ...
    instructions: Array.isArray(record == null ? void 0 : record.instructions) ? record.instructions : [],
    images: Array.isArray(record == null ? void 0 : record.images) ? record.images : []
  };
}
  ...
  if (sets.length === 0) {
    ...
    while (m = setTokenRe.exec(rest)) {
      ...
      if (m[4] === "bw") {
        ...
        const unit = (_a = m[7]) != null ? _a : DEFAULT_UNIT;
  ...
  for (const ex of exercises) {
    ...
    for (const set of ex.sets) {
      ...
      if (set.completed && (isBodyweight || (typeof weight === "number" ? true : Number.isFinite(weight.value)))) {
        ...
        totalReps += set.reps;
        if (isBodyweight) {
          const unit = (_c = (_b = opts.defaultBodyWeightUnit) != null ? _b : set.addedWeight.unit) != null ? _c : "lb";
          const bw = (_d = opts.defaultBodyWeight) != null ? _d : 0;
          ...
          const numeric = typeof weight === "number" ? weight : (_e = weight.value) != null ? _e : NaN;
        ...
        estimatedDurationSeconds += ((_f = set.restSeconds) != null ? _f : ex.restSeconds) + ((_g = set.seconds) != null ? _g : workSecondsPerSet);
      }
    }
  }
  return {
